...
- Familiarity with R programming (see the ["Just Enough R" section](https://sismid2026.callumarnold.com/just-enough-r) if you're new to R)
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/arnold-c/SISMID-Module-02_2026.git
   cd SISMID-Module-01_2026
   ```
...
### Reporting Issues
- **Found a bug or error?** Open an [Issue](https://github.com/arnold-c/SISMID-Module-01_2026/issues) describing the problem
- **Have a suggestion?** Start a [Discussion](https://github.com/arnold-c/SISMID-Module-01_2026/discussions) to share your ideas
- **Unclear instructions?** Let us know what could be explained better (open a [Discussion](https://github.com/arnold-c/SISMID-Module-01_2026/discussions))
