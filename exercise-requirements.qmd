...
If you use `{renv}` to manage package dependencies in your projects, you can visit the [GitHub repository](https://github.com/arnold-c/SISMID-Module-02_2026) for this project and download the ***renv.lock***, ***.Rprofile***, and ***renv/activate.R*** files, before running the command `renv::restore()`.
...
To download the files, go to the [GitHub repository](https://github.com/arnold-c/SISMID-Module-02_2026) and download the files in the `data/` folder of your repository.
