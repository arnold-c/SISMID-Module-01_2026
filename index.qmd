...
Welcome to this website that accompanies the [2026 Summer Institute in Modeling for Infectious Diseases (SISMID) Module 1: Mathematical Models of Infectious Diseases](https://sph.emory.edu/SISMID/modules/math-models/index.html).
...
<div class="box" style="--width: 50%">
<h3 style="margin-top:0px; text-align: center">[ Nicholas Adam](https://ecology.uga.edu/directory/nicholas-adam/)</h3>
<img src="./images/Nicholas-Adam.jpg" style="width: 100%"/>
Nicholas Adam is a doctoral student in the Drake Labs at the University of Georgia.
Adam's research focuses on using statistical leading indicators for infectious disease forecasting with an aim of improving health care and public health decision-makers confidence in model outputs use during epidemics. Nicholas is also the director for the Centre for Epidemiological and Mathematical Research in Malawi.
